...
stellaN1_node::stellaN1_node():Node("stella_md_node")
{
  ...
  update_timer_  = this->create_wall_timer(20ms, std::bind(&stellaN1_node::update_write, this));
  update_timer_2 = this->create_wall_timer(10ms, std::bind(&stellaN1_node::update_read,  this));
}
...
{  
  ...
  delta_left  = (encoder[0] - left_encoder_prev);
...
int main(int argc, char * argv[])
{
  ...
  MW_SerialOpen("/dev/ttyMD",115200);
  sleep(1.0);
